...
plt.title('PDP for X_2 for Random Forest Model')
plt.ylabel("Model Prediction")
plt.grid(True, linestyle="--", alpha=0.6)
plt.show
...
plt.title('PDP for X_2 for Linear Regression with Splines')
plt.ylabel("Model Prediction")
plt.grid(True, linestyle="--", alpha=0.6)
plt.show
```
...
#ale_explainer = ALE(predictor=model_forest.predict, feature_names=["X_1", "X_2", "X_3"])

#ale_exp = ale_explainer.explain(X.values)

#fig, ax = plt.subplots(figsize=(6, 5))

#plot_ale(ale_exp, features=["X_2"], ax=ax)
